...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center my-3">
            <div class="col-12">
            <form action="/dosenUpdate/{{$data->id}}" method="post" enctype="multipart/form-data">
                <div class="card">
                <div class="form-floating mb-3">
                    <input type="number" class="form-control" id="nidn" value="{{$data->nidn}}" name="nidn" placeholder="Masukkan NIDN">
               ...
               <div class="mb-3">
                 ...
                 <button type="submit" class="btn text-white float-end" style="background-color: #640101">Simpan</button>  
